...
- Generar campos para obtener información de área y perimétro de un polígono
keypoints:
- "QGIS nos permite la visualización de información geoespacial que representa ciertas ceracterísticas de la realidad."
---
# Pre-requisitos
